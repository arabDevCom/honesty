...
@endphp
@section('title', __('dashboard.news'))
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('dashboard.news')</h3>
                            ...
                            <table class="table table-bordered">
                                ...
                                @forelse($news as $new)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset( 'storage/' .  $new->image) }}" style="width: 100px"></td>
                                            ...
                                            <div class="operations-btns" style="">
                                                ...
                                                <a href="{{ route('news.show', $new->id) }}"
                                                   class="btn  btn-dark">@lang('dashboard.Show')</a>
                                                    ...
                                                    {{-- <a target="_blank" href="{{ route('news.loginFromAdmin', $new->id) }}" class="btn  btn-success">@lang('dashboard.Login')</a> --}}
